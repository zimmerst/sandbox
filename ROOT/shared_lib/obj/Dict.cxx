//
// File generated by /opt/exp_software/root/latest/bin/rootcint at Wed Apr  5 01:19:42 2017
...
namespace ROOTDict {
   ...
   {
      ::MyClass *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TInstrumentedIsAProxy< ::MyClass >(0);
      static ::ROOT::TGenericClassInfo 
         instance("MyClass", ::MyClass::Class_Version(), "./include/MyClass.h", 11,
                  typeid(::MyClass), ::ROOT::DefineBehavior(ptr, ptr),
                  &::MyClass::Dictionary, isa_proxy, 4,
                  sizeof(::MyClass) );
...
atomic_TClass_ptr MyClass::fgIsA(0);  // static to hold class pointer

//______________________________________________________________________________
const char *MyClass::Class_Name()
{
   return "MyClass";
}

//______________________________________________________________________________
const char *MyClass::ImplFileName()
{
   return ::ROOTDict::GenerateInitInstanceLocal((const ::MyClass*)0x0)->GetImplFileName();
}

//______________________________________________________________________________
int MyClass::ImplFileLine()
{
   return ::ROOTDict::GenerateInitInstanceLocal((const ::MyClass*)0x0)->GetImplFileLine();
}

//______________________________________________________________________________
void MyClass::Dictionary()
{
   fgIsA = ::ROOTDict::GenerateInitInstanceLocal((const ::MyClass*)0x0)->GetClass();
}

//______________________________________________________________________________
TClass *MyClass::Class()
{
   if (!fgIsA) { R__LOCKGUARD2(gCINTMutex); if(!fgIsA) {fgIsA = ::ROOTDict::GenerateInitInstanceLocal((const ::MyClass*)0x0)->GetClass();} }
   return fgIsA;
}
...
//______________________________________________________________________________
void MyClass::ShowMembers(TMemberInspector &R__insp)
{
      // Inspect the data members of an object of class MyClass.
      TClass *R__cl = ::MyClass::IsA();
...
static int G__Dict_227_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   ...
   if ((gvp == (char*)G__PVOID) || (gvp == 0)) {
     p = new MyClass((TString*) G__int(libp->para[0]));
   } else {
     p = new((void*) gvp) MyClass((TString*) G__int(libp->para[0]));
   }
   result7->obj.i = (long) p;
   result7->ref = (long) p;
   G__set_tagnum(result7,G__get_linked_tagnum(&G__DictLN_MyClass));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__Dict_227_0_3(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      ((MyClass*) G__getstructoffset())->run();
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      ((MyClass*) G__getstructoffset())->StreamerNVirtual(*(TBuffer*) libp->para[0].ref);
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
   MyClass* dest = (MyClass*) G__getstructoffset();
   *dest = *(MyClass*) libp->para[0].ref;
   const MyClass& obj = *dest;
...
extern "C" void G__cpp_setup_inheritanceDict() {
   ...
   /* Setting up class inheritance */
   if(0==G__getnumbaseclass(G__get_linked_tagnum(&G__DictLN_MyClass))) {
     MyClass *G__Lderived;
     G__Lderived=(MyClass*)0x1000;
     {
       TObject *G__Lpbase=(TObject*)G__Lderived;
       G__inheritance_setup(G__get_linked_tagnum(&G__DictLN_MyClass),G__get_linked_tagnum(&G__DictLN_TObject),(long)G__Lpbase-(long)G__Lderived,1,1);
     }
   }
}
...
static void G__setup_memvarMyClass(void) {
   G__tag_memvar_setup(G__get_linked_tagnum(&G__DictLN_MyClass));
...
static void G__setup_memfuncMyClass(void) {
   /* MyClass */
   G__tag_memfunc_setup(G__get_linked_tagnum(&G__DictLN_MyClass));
   G__memfunc_setup("internalMethod",1470,(G__InterfaceMethod) NULL, 121, -1, -1, 0, 0, 1, 4, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("MyClass",700,G__Dict_227_0_2, 105, G__get_linked_tagnum(&G__DictLN_MyClass), -1, 0, 1, 1, 1, 0, "U 'TString' - 0 - fname", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("run",341,G__Dict_227_0_3, 121, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Class",502,G__Dict_227_0_4, 85, G__get_linked_tagnum(&G__DictLN_TClass), -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (TClass* (*)())(&MyClass::Class) ), 0);
   G__memfunc_setup("Class_Name",982,G__Dict_227_0_5, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&MyClass::Class_Name) ), 0);
   G__memfunc_setup("Class_Version",1339,G__Dict_227_0_6, 115, -1, G__defined_typename("Version_t"), 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (Version_t (*)())(&MyClass::Class_Version) ), 0);
   G__memfunc_setup("Dictionary",1046,G__Dict_227_0_7, 121, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (void (*)())(&MyClass::Dictionary) ), 0);
   ...
   G__memfunc_setup("StreamerNVirtual",1656,G__Dict_227_0_11, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - ClassDef_StreamerNVirtual_b", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DeclFileName",1145,G__Dict_227_0_12, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&MyClass::DeclFileName) ), 0);
   G__memfunc_setup("ImplFileLine",1178,G__Dict_227_0_13, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&MyClass::ImplFileLine) ), 0);
   G__memfunc_setup("ImplFileName",1171,G__Dict_227_0_14, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&MyClass::ImplFileName) ), 0);
   G__memfunc_setup("DeclFileLine",1152,G__Dict_227_0_15, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&MyClass::DeclFileLine) ), 0);
   // automatic copy constructor
   G__memfunc_setup("MyClass", 700, G__Dict_227_0_16, (int) ('i'), G__get_linked_tagnum(&G__DictLN_MyClass), -1, 0, 1, 1, 1, 0, "u 'MyClass' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~MyClass", 826, G__Dict_227_0_17, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 1);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__Dict_227_0_18, (int) ('u'), G__get_linked_tagnum(&G__DictLN_MyClass), -1, 1, 1, 1, 1, 0, "u 'MyClass' - 11 - -", (char*) NULL, (void*) NULL, 0);
...
G__linked_taginfo G__DictLN_MyClass = { "MyClass" , 99 , -1 };
...
extern "C" void G__cpp_setup_tagtableDict() {
   ...
   G__tagtable_setup(G__get_linked_tagnum_fwd(&G__DictLN_MyClass),sizeof(MyClass),-1,324608,(char*)NULL,G__setup_memvarMyClass,G__setup_memfuncMyClass);
}
